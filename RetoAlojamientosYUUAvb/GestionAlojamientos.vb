...
Public Class GestionAlojamientos
	...
	Private Sub BtnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click, tbBusqueda.TextChanged
	...
	Private Sub DataGridAlojamientos_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridAlojamientos.CellContentClick
